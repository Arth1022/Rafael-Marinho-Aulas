public class ListaDupla<T>{
    ...
    public T removeMeio(int posicao){
        ...
        NoDuplo<T> helper = primeiroNo;
        int indice = 0;
        while(helper != null && indice < posicao){
            helper = primeiroNo.getProximoNo();
            indice++;
        }
        dadotemp = helper.getDado();
        helper.getAnteriorNo().setProximoNo(helper.getProximoNo());
        helper.getProximoNo().setAnteriorNo(helper.getAnteriorNo());
        helper.setAnteriorNo(null);
        helper.setProximoNo(null);
        atualizaIndice();
        tamanho --;
        return dadotemp;
    }
